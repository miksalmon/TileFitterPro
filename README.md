...
This UWP console application is a command line interface to interact with the [TileFitter](#tilefitter) library to output solutions to a specified problem.
